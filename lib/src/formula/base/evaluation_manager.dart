...
class EvaluationManager {
  ...
  static final TypedKey<VariableStore> results = TypedKey();
  ...
  static final TypedKey<Object> input = TypedKey();

  EvaluationManager getWith<T>(TypedKey<T> key, T value) {
    final replacement = EvaluationManager();
    replacement._map.addAll(_map);
