...
//
// Translation of pcgen.cdom.facet.analysis.StatMinValueFacet
...
/// Tracks [StatLock] objects that set a minimum value on a PCStat.
class StatMinValueFacet extends AbstractSourcedListFacet<CharID, StatLock>
  ...
  void dataAdded(DataFacetChangeEvent<CharID, CDOMObject> dfce) {
    final locks = dfce.getCDOMObject()
        .getListFor(ListKey.getConstant<StatLock>('STAT_MINVALUE'));
    if (locks != null) {
  ...
  /// Returns the maximum of all minimum-value constraints for [stat], or null.
  num? getStatMinValue(CharID id, PCStat stat) {
