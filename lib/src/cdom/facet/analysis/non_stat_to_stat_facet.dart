...
class NonStatToStatFacet extends AbstractSourcedListFacet
  ...
  void dataAdded(dynamic dfce) {
    ...
    final locks = cdo.getListFor('NONSTAT_TO_STAT_STATS') as List?;
    if (locks != null) {
  ...
  /// Initializes the connections for NonStatToStatFacet to other facets.
  void init() {
