...
class ClassInfo {
  ...
  bool setClassLevel(dynamic pcc, dynamic pcl) {
    ...
    // stub: pcl.ownBonuses(pcc); pcl.putObject(CDOMObjectKey.PARENT, pcc);
  ...
  dynamic getClassLevel(dynamic pcc, int level) {
    ...
    if (classLevel == null) {
      // stub: classLevel = pcc.getOriginalClassLevel(level); classLevel.putObject(CDOMObjectKey.PARENT, pcc);
